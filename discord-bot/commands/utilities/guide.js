...
const PAGES = [
  {
    ...
    description: [
      ...
      `> Demo Robux let you try every game — and you **always win** on demo!`,
      ...
      `> First 5 small bets after deposit are boosted 🎉`,
      ``,
  ...
  },
  {
    ...
    description: [
      ...
      `> \`.deposit <amount>\` — open a deposit ticket (admin pinged immediately)`,
      `> \`.withdraw <amount>\` — open a withdrawal ticket (admin pinged immediately)`,
      `> You must wager your deposit before you can withdraw`,
      ``,
      `**Vault (safe storage):**`,
  ...
  },
  {
    ...
    color: 0x57F287,
    description: [
      `**Every game has a 5-second loading screen before it starts.**`,
      ``,
      `**Coin & Cards:**`,
  ...
  },
  {
    ...
    description: [
      ...
      `• Demo balance **always wins** — great for practice!`,
      `• First 5 small bets after a deposit are guaranteed wins`,
